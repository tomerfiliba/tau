...
public class Gui {
	...
	protected void createContents() {
		...
		shlPonyTrivia.setLayout(new GridLayout(2, false));
		...
		GridData gd_btnPlayGame = new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1);
		gd_btnPlayGame.heightHint = 94;
		gd_btnPlayGame.widthHint = 207;
		...
		gd_btnImportImdbFiles.widthHint = 208;
